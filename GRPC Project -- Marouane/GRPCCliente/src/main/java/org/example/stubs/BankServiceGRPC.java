...
import static io.grpc.stub.ClienteCalls.asyncBidiStreamingCall;
import static io.grpc.stub.ClienteCalls.asyncClienteStreamingCall;
import static io.grpc.stub.ClienteCalls.asyncServerStreamingCall;
import static io.grpc.stub.ClienteCalls.asyncUnaryCall;
import static io.grpc.stub.ClienteCalls.blockingServerStreamingCall;
import static io.grpc.stub.ClienteCalls.blockingUnaryCall;
import static io.grpc.stub.ClienteCalls.futureUnaryCall;
import static io.grpc.stub.ServerCalls.asyncBidiStreamingCall;
import static io.grpc.stub.ServerCalls.asyncClienteStreamingCall;
...
public final class BankServiceGrpc {
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = Bank.ConvertCurrencyRequest.class,
      responseType = Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.Cliente_STREAMING)
  public static io.grpc.MethodDescriptor<Bank.ConvertCurrencyRequest,
      Bank.ConvertCurrencyResponse> getPerformStreamMethod() {
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getPerformStreamMethod = BankServiceGrpc.getPerformStreamMethod) == null) {
          BankServiceGrpc.getPerformStreamMethod = getPerformStreamMethod = 
              io.grpc.MethodDescriptor.<Bank.ConvertCurrencyRequest, Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.Cliente_STREAMING)
              .setFullMethodName(generateFullMethodName(
  ...
  public static final class BankServiceStub extends io.grpc.stub.AbstractStub<BankServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<Bank.ConvertCurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<Bank.ConvertCurrencyResponse> responseObserver) {
      return asyncClienteStreamingCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
      ...
      io.grpc.stub.ServerCalls.ClienteStreamingMethod<Req, Resp>,
